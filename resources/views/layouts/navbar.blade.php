            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        ...
                        <a href="#" class="dropdown-item">الدراسات الإسلامية</a>
                        <a href="#" class="dropdown-item">التمريض</a>
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        <a href="#" class="dropdown-item">المسجل</a>
                        <a href="#" class="dropdown-item">شؤون العلمية</a>
                        <a href="#" class="dropdown-item">شؤون الأطلاب</a>
                    </div>
                </div>
